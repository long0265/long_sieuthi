						...
						<div class="your-order">
							...
							<div class="your-order-body" style="padding: 0px 10px">
								...
								<div class="your-order-item">
									...
									<div class="pull-right"><h5 class="color-black">@if(Session::has('cart')){{$totalPrice}} @else 0 @endif</h5></div>
									<div class="clearfix"></div>
								</div>
							</div>
							...
							<div class="text-center"><button type="subnit" class="beta-btn primary" href="#">Đặt hàng <i class="fa fa-chevron-right"></i></button></div>
						</div> <!-- .your-order -->
					</div>
				</div>
			</form>
