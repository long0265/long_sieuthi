			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> 32 Sông Nhuệ - Từ Liêm - Hà Nội</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 01667699951</a></li>
					</ul>
				</div>
				<div class="pull-right auto-width-right">
					<ul class="top-details menu-beta l-inline">
						...
						<li><a href="{{route('admindangnhap')}}">Đăng nhập admin</a></li>
					</ul>
				</div>
