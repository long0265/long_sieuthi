             <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="admin/chitietsanpham/danhsach"><i class="fa fa-cube fa-fw"></i> Chi tiết sản phẩm<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/chitietsanpham/danhsach">Danh sách</a>
                                </li>
                                <li>
                                    <a href="admin/chitietsanpham/them">Thêm</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
